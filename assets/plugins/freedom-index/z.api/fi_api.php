...
define('PATH_APP',WP_CONTENT_DIR.'/plugins/freedom-scorecard/');
define('PATH_APP_CORE', PATH_APP.'core/');
define('PATH_APP_ACTION', PATH_APP.'api/actions/');
define('PATH_APP_LOAD', PATH_APP.'api/autoload/');
define('PATH_CACHE', WP_CONTENT_DIR.'/cache/api/');
define('PATH_LOG', PATH_CACHE . 'api_log/');
define('SITE_KEY', md5('freedom-scorecard-us'));
define('URL_APP',home_url().'/'.FILE_APP.'?key='.SITE_KEY);


if(strpos(__DIR__,'/var/www/html') !== false){
	define('DB_NAME', 'vtstllthtrth_scorecard');
	define('DB_USER', 'root');
	define('DB_PASSWORD', '9MMGlock19');
	define('WP_CONTENT_URL', 'http://localhost/votestellthetruth/assets');
} else {
	define('DB_NAME', 'vtstllthtrth_scorecard');
