...
*/
?>
<div id="home-answer" class="container-fluid p-0 border-bottom bg-amber-light-1">
	<div class="container py-5">
		<div class="row g-0">
			<div class="col-12 col-md-6 pb-4 pb-md-0">
				<p class="text-uppercase text-anchor fs-6">One number tells a story</p>
				<p class="fs-5">The Constitution was written to keep government small and your life big.</p>
				<p class="fs-5">A <span class="fw-7">Freedom Score</span> tells you how often your legislators voted to protect your rights, wallet, country, and independence.</p>
			</div>
			<div class="col-12 col-md-6">
				<?php get_template_part('template-parts/home-answer-chart'); ?>
			</div>
		</div>
	</div>
</div>