...
global $post;
$slug = $post->post_name;
//$form_redirect_to = '<input type="hidden" name="fs_redirect_to" value="' . esc_url(get_permalink($post->ID)) . '">';
...
if(defined('FS_VERSION')):
	switch($slug):
		case 'account':
			include FS_PUBLIC_DIR . 'account/account.php';
			break;
		case 'dashboard':
			include FS_PUBLIC_DIR . 'account/account-dashboard.php';
			break;
		case 'lists':
			include FS_PUBLIC_DIR . 'account/account-lists.php';
			break;
	// Handle edit in lists page
	//	case 'list':
	//		include FS_PUBLIC_DIR . 'account/account-list.php';
	//		break;
		case 'profile':
			include FS_PUBLIC_DIR . 'account/account-profile.php';
			break;
		case 'personalize':
			include FS_PUBLIC_DIR . 'account/account-personalize.php';
			break;
		case 'notifications':
			include FS_PUBLIC_DIR . 'account/account-notifications.php';
			break;
		default:
