...
*/
define('FS_SHOP_TAG',4364); //freedom-index
...
<?php
global $wpdb;
$tag_query = $wpdb->get_results( "SELECT `object_id` FROM `jbsw_3_term_relationships` WHERE `term_taxonomy_id` ='".FS_SHOP_TAG."' order by object_id desc", ARRAY_A );
